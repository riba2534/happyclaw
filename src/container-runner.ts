...
export async function runHostAgent(
  ...
  try {
    ...
    const hostResult = await new Promise<ContainerOutput>((resolve) => {
      ...
      const handleOutput = createRunnerProviderOutputHandler(
        hostProviderState,
        {
          groupName: group.name,
