    ...
    <div>
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-3 py-2 text-sm font-medium text-primary bg-primary/5 border border-primary/20 rounded-lg hover:bg-primary/10 transition-colors cursor-pointer whitespace-nowrap"
        >
          {browsing ? '收起' : '浏览'}
        </button>
      </div>
                ...
                {directories.map((dir) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="px-2 py-1 text-xs font-medium text-primary bg-primary/5 hover:bg-primary/10 rounded transition-colors cursor-pointer flex-shrink-0 ml-2"
                    >
                      选择
                    </button>
                  </div>
